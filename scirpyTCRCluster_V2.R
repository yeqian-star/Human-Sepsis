...
#path1 = "/media/nbc1/lijialun/scirpy/zhenbo/inputfile"
setwd(path1)

# inputrds1 = "/media/nbc1/lijialun/scirpy/zhenbo/inputfile/CD4T.GraphClust.seuset.rds"
# inputrds1 = "/media/nbc1/lijialun/scirpy/zhenbo/inputfile/CD8T.GraphClust.seuset.rds"
# inputrds1 = "/media/nbc1/lijialun/scirpy/zhenbo/inputfile/gdTnew.GraphClust.seuset.rds"
